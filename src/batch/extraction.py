...
extraction.py
-------------
Handles Steps 1–3 of document_processor for Indian legal documents.

  Step 1 — Input Handling:    PDF / DOCX / raw text → plain text
  Step 2 — Segmentation:      plain text → list of clauses
  Step 3 — Preprocessing:     each clause → clean text for pipeline

Indian legal documents covered:
  - Rental / Lease / Leave-and-License Agreement
  - Sale Deed / Gift Deed / Relinquishment Deed
  - Power of Attorney (General / Special / NRI)
...
Clause styles found across these documents:
  ┌─────────────────────────────────────────────────────────────────┐
  │ Style              │ Example                                    │
  ├─────────────────────────────────────────────────────────────────┤
  │ That-numbered      │ 1. That the tenant shall pay...            │
  │ Bare-numbered      │ 1. The Employee agrees to...               │
  │ Article/Section    │ Article 1 – Definitions                    │
  │                    │ Section 2. Term of Employment              │
  │                    │ Clause 4.5 – Powers                        │
  │ Roman numerals     │ I. The testator bequeaths...               │
  │ FIRST/SECOND       │ FIRST: I give and bequeath...              │
  │ WHEREAS recitals   │ WHEREAS the parties desire...              │
  │ AND WHEREAS        │ AND WHEREAS the seller is seized...        │
  │ Bridge lines       │ NOW THEREFORE / NOW THIS DEED WITNESSETH   │
  │                    │ NOW KNOW YOU ALL                           │
  │ THAT paragraphs    │ THAT the opposite party...  (legal notice) │
  │ Subclauses         │ (a) (b) (i) (ii) (iii)                    │
  │ ALL CAPS headings  │ TERMINATION    CONFIDENTIALITY             │
  │ Title Case heading │ Security Deposit:   Notice Period:         │
  └─────────────────────────────────────────────────────────────────┘
"""
